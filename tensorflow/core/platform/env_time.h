...
/// \brief An interface used by the tensorflow implementation to
/// access timer related operations (uses CPU timers for current thread).
class ThreadExecutionTime {
 public:
  static constexpr uint64 kMicrosToPicos = 1000ULL * 1000ULL;
  static constexpr uint64 kMicrosToNanos = 1000ULL;
  static constexpr uint64 kMillisToMicros = 1000ULL;
  ...
  ThreadExecutionTime() = default;
  virtual ~ThreadExecutionTime() = default;

  /// \brief Returns the id clock of the calling thread.
  static int64 ClockId();

  /// \brief Returns the number of nano-seconds since the Unix epoch.
  static uint64 NowNanos();

  /// \brief Returns the resolution in the number of nano-seconds.
  static uint64 ResolutionNanos();
...
// Like ThreadExecutionTime, but attempts to calibrate to wallclock time to make
// calls cheap
class FastThreadExecutionTime : public ThreadExecutionTime {
 public:
  static constexpr uint64 kMicrosToPicos = 1000ULL * 1000ULL;
  static constexpr uint64 kMicrosToNanos = 1000ULL;
  static constexpr uint64 kMillisToMicros = 1000ULL;
  ...
  FastThreadExecutionTime() = default;
  virtual ~FastThreadExecutionTime() = default;
...
/// \brief An interface used by the tensorflow implementation to
/// access timer related operations (uses CPU timers for current process).
class ProcessExecutionTime {
 public:
  static constexpr uint64 kMicrosToPicos = 1000ULL * 1000ULL;
  static constexpr uint64 kMicrosToNanos = 1000ULL;
  static constexpr uint64 kMillisToMicros = 1000ULL;
  ...
  ProcessExecutionTime() = default;
  virtual ~ProcessExecutionTime() = default;
